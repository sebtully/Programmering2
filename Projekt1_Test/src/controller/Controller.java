...
public class Controller {
	...
	public PN opretPNOrdination(LocalDate startDen, LocalDate slutDen,
		...
		if(startDen == null || slutDen == null || patient == null || laegemiddel == null){
			throw new NullPointerException("Startdato, slutdato, patient eller lægemiddel er null");
		}
		if(antal < 0){
			throw new IllegalArgumentException("Antal er mindre end 0");
		}
		return pn;
	}
	...
	public DagligSkaev opretDagligSkaevOrdination(LocalDate startDen,
		...
		DagligSkaev dagligSkaev = new DagligSkaev(startDen, slutDen, laegemiddel, patient);
		...
		if(klokkeSlet.length != antalEnheder.length){
			throw new IllegalArgumentException("Klokkeslet og antalEnheder er ikke lige lange");
		}
	...
	public void ordinationPNAnvendt(PN ordination, LocalDate dato) {
		if(dato != null && ordination != null){
			throw new NullPointerException("Dato eller ordination er null");
		}
	...
	public double anbefaletDosisPrDoegn(Patient patient, Laegemiddel laegemiddel) {
		if (patient == null || laegemiddel == null) {
			throw new IllegalArgumentException("Patient eller lægemiddel er null");
		}
